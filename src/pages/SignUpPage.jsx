...
export default function SignUpPage(){
    ...
    return(
        <div className="flex flex-col mt-24 h-full items-center justify-center">
            <form onSubmit={handleSignUp} className="flex flex-col gap-10 h-full text-center justify-center items-center border-[5px] border-gray-300 w-[500px] py-10 rounded-lg">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input onChange={(e) => setEmail(e.target.value)} type="email" id="email" name="email" placeholder="Email" className="bg-white border"/>
                </div>
